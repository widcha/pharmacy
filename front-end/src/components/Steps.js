      ...
      <div className="grid max-w-2xl mx-auto">
          ...
          <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-0">
            <div className="sm:mr-5">
              <div className="flex items-center justify-center w-16 h-16 my-3 rounded-full bg-indigo-50 sm:w-24 sm:h-24">
                <svg
                  className="w-12 h-12 text-blue-500 sm:w-16 sm:h-16"
                  stroke="currentColor"
                  viewBox="0 0 52 52"
                >
                  <polygon
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">
                All presciption are written using certain conventions, which
                define the characteristics of common ingredients. The rules vary
                from place to place.
              </p>
            </div>
          </div>
        ...
        <div className="flex">
          ...
          <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-0">
            ...
            <div>
              <p className="text-xl font-semibold sm:text-base">Checkout</p>
              <p className="text-sm text-gray-700">
