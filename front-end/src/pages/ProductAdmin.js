...
const ProductAdmin = () => {
    ...
    const renderProduct = () => {
        if(data){
            if(filterCategory){
                return data.filter((val) => val.product_category_id === filterCategory).map((val) => {
                    return (
                        <div className="mt-3">
                            <CardProduct
                ...
                <div>
                    <div style={{ display: 'flex', flexDirection: 'row' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', width: '275px', paddingTop: '17px', maxHeight: '50px', position: 'fixed', left: '78%' }}>
                            <Button style={{ backgroundColor: '#2F4F4F', color: 'white' }} onClick={toggle}>
                                Add New Product
                            </Button>
                            {/* SORT */}
