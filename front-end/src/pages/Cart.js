...
export const Cart = () => {
	...
	const handleIncrementCustom = debounce(
		(current_custom_product_qty, custom_product_price, custom_product_id) => {
			dispatch(
				userAddCustomQtyAction({
	...
	const handleDecrementCustom = debounce(
		(current_custom_product_qty, custom_product_price, custom_product_id) => {
			dispatch(
				userSubCustomQtyAction({
					current_custom_product_qty,
			...
			if (val.custom_product_id === null) {
				...
				return (
					<CartCard
						...
						custom_qty={val.custom_product_qty}
						incrementCustom={handleIncrementCustom}
						decrementCustom={handleDecrementCustom}
					/>
				);
			}
		});
	...
	return (
		<div className="flex justify-center my-6">
			<div className="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5">
				<label className="text-2xl font-bold border-gray-400 border-b-2 mb-3 flex items-center">
					<svg
						class="w-6 h-6 mr-3"
						fill="currentColor"
						viewBox="0 0 20 20"
